...
Time range: between 2024-01-01 and 2024-03-31 

```{r}
gtrends(keyword = "'work visa'", time = "2024-01-01 2024-03-31",
...
for (i in 1:length(EUcountries)) {
    example2 = rbind(example, (gtrends(keyword = "asylum", geo = EUcountries[i],
                              time = "2024-01-01 2024-03-31", gprop = "web",
...
## Keyword as topic: Columbus vs. Columbus

```{r}

# as keyword
gtrends(keyword = "columbus", time = "2024-01-01 2024-03-31",
        gprop = "web", hl = "en", low_search_volume = TRUE)

# as topic (uses Freebase ID)
gtrends(keyword = "/m/01smm", time = "2024-01-01 2024-03-31",
        gprop = "web", hl = "en", low_search_volume = TRUE)
